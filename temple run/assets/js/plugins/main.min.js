...
var FullCalendar = function(e) {
    ...
    var Ni = function() {
        function e(e) {
            ...
            l = o.dateEnv,
            null != (u = s.initialDate) ? l.createMarker(u) : Tr(s.now, l)), d = a.dateProfileGenerator.build(c);
      ...
      , qi = function() {
        ...
        e.prototype.insertEntryAt = function(e, t) {
            var n = this.entriesByLevel
              , r = this.levelCoords;
            -1 === t.lateral ? (Ji(r, t.level, t.levelCoord),
            Ji(n, t.level, [e])) : Ji(n[t.level], t.lateral, e),
            ...
            for (var m in u) {
                ...
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x = k[T]
                      ...
                      , P = _.instances[m]
                      , N = void 0;
                    if (N = I ? new xr(t,I,P) : new xr(t,b),
                    !x(yr(M, t), N))
                        return !1
                }
            }
    ...
    function Es(e) {
        ...
        return {
            ...
            t.reduce(Ds).eventRange.range.end)
        }
    }
    function Ss(e) {
    ...
    var Ls = function() {
        ...
        e.prototype.handleMove = function(e, t) {
            ...
            !t && Us(this.movingHit, n) || (this.movingHit = n,
      ...
      , Fs = function(e) {
        function t(t) {
            ...
            n.handlePointerUp = function(e) {
                n.dragSelection && (mr(n.dragSelection, e, n.component.context),
                n.dragSelection = null)
            }
            ;
    ...
    var zs = function(e) {
        function t(t) {
            ...
            n.handleHitUpdate = function(e, t, r) {
                ...
                l && (u = Sr(i, o.getCurrentData().eventUiBases, l, o),
                d.mutatedEvents = u,
                Ia(d, e.dateProfile, o) || (c = !0,
                l = null,
                u = null,
      ...
      , Ys = function() {
        function e(e, t) {
            ...
            this.handleHitUpdate = function(e, t, o) {
                ...
                (l = !Ia(u, e.dateProfile, a)) && (u.mutatedEvents = {
                    defs: {},
                    instances: {}
                },
                s = null))),
      ...
      , Zl = function(e) {
        ...
        t.prototype.renderHiddenGroups = function(e, t) {
            ...
            return _o(xo, null, e.map((function(e) {
                var n, c, d = Kl(e.span), p = (n = e.entries,
                c = t,
                n.map((function(e) {
                    return c[e.index]
                }
    ...
    return xi.push($s, Cl, su, mu, Eu, bu, Cu),
