!function(e, t) {
    ...
    function J(e) {
        ...
        const n = z();
        ce(n) && (t && (n.style.transition = "none",
        n.style.width = "100%"),
        setTimeout(()=>{
    ...
    const X = {
      ...
      , be = ()=>{
        const e = m();
        return !!e && (e.remove(),
        oe([document.documentElement, document.body], [p["no-backdrop"], p["toast-shown"], p["has-column"]]),
        !0)
    }
      , ye = ()=>{
    ...
    const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      ...
      , He = {}
      , Ie = (He.text = He.email = He.password = He.number = He.tel = He.url = (e,t)=>("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : A(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
    Me(e, e, t),
    je(e, t),
    e.type = t.input,
    e),
    He.file = (e,t)=>(Me(e, e, t),
    je(e, t),
    e),
    He.range = (e,t)=>{
    ...
    (e,t)=>{
      ...
      , Ne = (e,t)=>{
        ...
        void Re(n, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(S).indexOf(t.icon) ? (v('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')),
        h(n)) : (d(n),
        ze(n, t),
        Re(n, t),
      ...
      , ze = (e,t)=>{
        var n;
        e.textContent = "",
        t.iconHtml ? l(e, Ke(t.iconHtml)) : "success" === t.icon ? l(e, Ue) : "error" === t.icon ? l(e, We) : (n = {
            question: "?",
            warning: "!",
            info: "i"
        },
      ...
      , Xe = (e,t)=>{
        var n = m();
        const o = g();
        t.toast ? (ae(n, "width", t.width),
        o.style.width = "100%",
        o.insertBefore(R(), j())) : ae(o, "width", t.width),
        ae(o, "padding", t.padding),
        t.color && (o.style.color = t.color),
        t.background && (o.style.background = t.background),
        h(q());
        n = o;
        (n.className = "".concat(p.popup, " ").concat(ce(n) ? t.showClass.popup : ""),
      ...
      , it = e=>{
        ...
        return n && (lt(n, ["src", "width", "height", "alt"]),
      ...
      , rt = e=>{
        ...
        t && (lt(t, ["type", "label", "placeholder", "value"]),
    ...
    const mt = ()=>{
      ...
      , wt = (e,t)=>{
        Be && de(t) ? (e.style.overflowY = "hidden",
        t.addEventListener(Be, vt)) : e.style.overflowY = "auto"
    }
      , Ct = (e,t,n)=>{
        ht(),
        t && "hidden" !== n && mt(),
      ...
      , Pt = (t,n)=>{
        ...
        C(n.inputOptions) || A(n.inputOptions) ? (At(V()),
      ...
      , Et = n=>{
        ...
        return "undefined" != typeof Map && n instanceof Map ? n.forEach((e,t)=>{
            let n = e;
            "object" == typeof n && (n = Et(n)),
            o.push([t, n])
        }
        ) : Object.keys(n).forEach(e=>{
            let t = n[e];
            "object" == typeof t && (t = Et(t)),
            o.push([e, t])
        }
        ),
        o
    ...
    function St() {
        ...
        if (t) {
            ...
            h(n.loader),
            Z() ? t.icon && d(j()) : (t = n,
            (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? d(e[0], "inline-block") : le() && h(t.actions)),
    ...
    function jt(e) {
        ...
        var n = (e=>{
            ...
            const o = m();
            return oe(o, n.showClass.backdrop),
    ...
    const Vt = e=>{
        e.isAwaitingPromise() ? (Nt(b, e),
        b.awaitingPromise.set(e, !0)) : (Nt(Lt, e),
        Nt(b, e))
    }
      , Nt = (e,t)=>{
        for (const n in e)
    ...
    e = Object.freeze({
        ...
        _destroy: function() {
            ...
            delete f.currentInstance) : Vt(this)
        }
    });
    const Rt = (e,t)=>{
        var n = b.innerParams.get(e);
        if (!n.input)
            return v('The "input" parameter is needed to be set when using returnInputValueOn'.concat(y(t)));
        var o = ((e,t)=>{
            const n = e.getInput();
            if (!n)
                return null;
        ...
        if (n.inputValidator) {
            ...
            e.getInput().checkValidity() ? ("deny" === t ? Ft : zt)(e, o) : (e.enableButtons(),
            e.showValidationMessage(n.validationMessage))
    }
      , Ft = (t,n)=>{
        const e = b.innerParams.get(t || void 0);
        if (e.showLoaderOnDeny && At(N()),
        e.preDeny) {
      ...
      , zt = (t,n)=>{
        const e = b.innerParams.get(t || void 0);
        if (e.showLoaderOnConfirm && At(),
        e.preConfirm) {
            t.resetValidationMessage(),
            b.awaitingPromise.set(t || void 0, !0);
            const o = Promise.resolve().then(()=>k(e.preConfirm(n, e.validationMessage)));
            o.then(e=>{
                ce(q()) || !1 === e ? (t.hideLoading(),
                Mt(t)) : Ut(t, void 0 === e ? n : e)
            }
            ).catch(e=>Wt(t || void 0, e))
        } else
            Ut(t, n)
      ...
      , en = (e,n,o)=>{
        ...
        if (i && (!n.isComposing && 229 !== n.keyCode))
            ...
            "Enter" === n.key)
                ...
                a = n,
                t = i,
                w(t.allowEnterKey) && a.target && e.getInput() && a.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(t.input) || (Xt(),
                a.preventDefault()));
            else if ("Tab" !== n.key) {
    ...
    var ln = Object.freeze({
        ...
        bindClickHandler: function() {
            ...
            sn[e] = this,
            rn || (document.body.addEventListener("click", cn),
            rn = !0)
        }
    });
    let un;
    ...
    const pn = (l,u,d)=>new Promise((e,t)=>{
        ...
        t = u,
        a = n,
        b.innerParams.get(e).toast ? _t(e, t, a) : (Yt(t),
        Zt(t),
        Jt(e, t, a)),
        o = l,
        e = f,
        ...
        t.toast || (e.keydownHandler = e=>en(o, e, i),
        ...
        a = l,
        "select" === (t = d).input || "radio" === t.input ? Pt(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (C(t.inputValue) || A(t.inputValue)) && (At(V()),
        Bt(a, t));
        {
            var r = d;
            const s = m()
      ...
      , bn = (e,t)=>t.focusDeny && ce(e.denyButton) ? (e.denyButton.focus(),
    ...
    !0)
      ...
      , vn = (Object.assign(dn.prototype, e),
    Object.assign(dn, ln),
