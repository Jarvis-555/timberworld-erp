                    ...
                    var e = t((function(t, e) {
                        t.exports = function() {
                            ...
                            var O = function() {
                                ...
                                ,
                                D.$set = function(t, e) {
                                    var n, u = w.p(t), h = "set" + (this.$u ? "UTC" : ""), l = (n = {},
                                    n[o] = h + "Date",
                                    n[d] = h + "Date",
                                    n[f] = h + "Month",
                                    n[c] = h + "FullYear",
                                ...
                                D.diff = function(r, d, l) {
                                    var $, M = w.p(d), m = S(r), D = (m.utcOffset() - this.utcOffset()) * e, v = this - m, p = w.m(this, m);
                                    return p = ($ = {},
                                    $[c] = p / 12,
                                    $[f] = p,
                                    $[h] = p / 3,
                ...
                order(t) {
                    ...
                    o.data.forEach(((e,s)=>{
                        ...
                        t.forEach((t=>{
                            ...
                            i.appendChild(r),
                            o.hiddenColumns.includes(t) || (r = e.cells[t].cloneNode(!0),
                            r.data = e.cells[t].data,
                            a.appendChild(r))
                        }
                        )),
            ...
            class o {
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        this.dom.tHead) {
                            if (this.options.scrollY.length && (s = e("thead"),
                            s.appendChild(e("tr")),
                            s.style.height = "0px",
                    ...
                    if (o.type) {
                        ...
                        if (i.length) {
                            if ("txt" === o.type || "csv" === o.type) {
                                ...
                                for (r = `INSERT INTO \`${o.tableName}\` (`,
                                n = 0; n < s.length; n++)
                                    !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (r += `\`${s[n].textContent}\`,`);
                                for (r = r.trim().substring(0, r.length - 1),
                                r += ") VALUES ",
                                n = 0; n < i.length; n++) {
                                    for (r += "(",
                                    h = 0; h < i[n].cells.length; h++)
                                        !o.skipColumn.includes(s[h].originalCellIndex) && this.columns(s[h].originalCellIndex).visible() && (r += `"${i[n].cells[h].textContent}",`);
                                    r = r.trim().substring(0, r.length - 1),
                                    r += "),"
                                }
                                r = r.trim().substring(0, r.length - 1),
                                r += ";",
                                o.download && (r = `data:application/sql;charset=utf-8,${r}`)
                            } else if ("json" === o.type) {
                                ...
                                o.download && (r = `data:application/json;charset=utf-8,${r}`)
                            }
